...
const GlowingProfile = () => {
  return (
    <div className="relative w-[250px] h-[250px] mt-8 mb-8">
      ...
      <div className="relative w-[250px] h-[250px] overflow-hidden rounded-full ring-1 ring-green-400/30 pointer-events-none select-none">
        <Image
          src="/profile-pic.png"
